"""
Trains a Logistic Regression linear probe on the extracted CXR Text (Reports) embeddings.
...
output_dir = Config.CXR_TXT_LR_MODEL_DIR
...
def main():
    ...
    logger.info("--- Loading CXR Text (Reports) Data ---")
    ...
    print_metrics(test_metrics, name="CXR TXT TEST SET (Logistic Regression)")
    ...
    # TensorBoard logging
    tb_dir = Config.TENSORBOARD_LOG_DIR / "cxr_txt" / "lr"
