"""
Trains an XGBoost classifier on the extracted CXR Text (Reports) embeddings.
...
output_dir = Config.CXR_TXT_XGBOOST_MODEL_DIR
...
tb_log_dir = Config.TENSORBOARD_LOG_DIR / "cxr_txt" / "xgboost"
...
def main():
    ...
    logger.info("--- Loading CXR Text Data ---")
    ...
    print_metrics(test_metrics, name="CXR TXT TEST SET (XGBoost)")
